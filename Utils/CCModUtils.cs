...
namespace CCMod.Utils
{
    public static partial class CCModUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] 
        public static Vector2 NormalizedOrZero(this Vector2 vector) => NormalizedOr(vector, Vector2.Zero);
        ...
        /// <returns>The normalized <paramref name="vector"/>, or <paramref name="fallback"/> if one of the normalized vector components is not finite.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)] 
        public static Vector2 NormalizedOrOne(this Vector2 vector) => NormalizedOr(vector, Vector2.One);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool HasNonFinite(this Vector2 vector) => !float.IsFinite(vector.X) || !float.IsFinite(vector.Y);
        ...
        public static Vector2 FiniteOr(this Vector2 vector, Vector2 fallback)
            => float.IsFinite(vector.X) && float.IsFinite(vector.Y) ? vector : fallback;
        ...
        public static Vector2 FiniteOrZero(this Vector2 vector)
            => float.IsFinite(vector.X) && float.IsFinite(vector.Y) ? vector : Vector2.Zero;
